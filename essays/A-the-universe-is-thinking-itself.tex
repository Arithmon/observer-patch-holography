...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Every pair of the three requirements has a solution. The complete cycle has none. Local compatibility tests must be supplemented by a test of how the comparisons compose.}]{figures/fig-cycle-obstruction.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={A change of units removes a redundant presentation. Omitting an agent's relation to an object answers a less specific question. Objectivity does not require discarding the relation that makes a door an exit for someone.}]{figures/fig-public-invariants.pdf}}
...
a symmetric competition, and interactions amplify the bias
...
settlement moves toward what the nudge produced.\footnote{Practical
  variants use one weak nudge or compare opposite nudges.}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Inference settles a state under evidence. Learning compares nearby settlements and changes local parameters. A remembered correction can then affect the next unprompted answer.}]{figures/fig-learning-repair.pdf}}
...
The account could be accepted as a proposal about cognition and
