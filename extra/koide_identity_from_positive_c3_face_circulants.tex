...
ancestry is declared: the balance premise is the equal-weight condition on
the two response sectors of one icosahedral face circulant, a geometric
condition of the carrier that reproduces the relation Koide published for
the measured charged-lepton masses, so the window is a conditional
postdiction whose evidential weight lies in the kill direction. Improving tau-mass averages test the balanced-circulant premise
directly.
