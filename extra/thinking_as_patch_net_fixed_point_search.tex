...
questions. The boxed sentences below are interpretive claims about how the
formalism reads those questions, not derived theorems, and no certification
...
\]
This is an interpretive claim about how the model reads the question,
not a derived theorem; the sentence below records the structural
reading the model assigns.
...
\]
As above, this is an interpretive claim about how the model reads the
question, and not a derived theorem. No certification gate stands
behind it.
