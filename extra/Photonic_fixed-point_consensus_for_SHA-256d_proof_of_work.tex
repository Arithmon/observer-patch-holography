...
application of the Secure Hash Algorithm 256, usually written SHA-256d. A
proposed optical machine implements bounded observer-like patches with local
state, ports, readback, retained records and feedback. Its settling dynamics
proposes candidates for the exact digital verifier.

One mining instance is compiled into constraint patches for nonce choice,
message schedule, compression and target checking. An experimental scorebook
specifies enrichment measurement per settling event through blinded routes,
label shuffles, operator-alignment controls and exact SHA-256d receipts.
\end{abstract}
...
B. Mueller, A. Osika, M. Poneder, K. Xue, B. Cassie, P. Nguyen, J. Kim, D. Matscheko, J. Hill, W. T. Glynn, M. A. Visser, K. A. Anirudha, and B. de La Fourni\`ere,
...
B. Mueller, A. Osika, M. Poneder, K. Xue, P. Nguyen, M. A. Visser, D. Matscheko, and B. de La Fourni\`ere,
...
B. Mueller, A. Osika, K. Xue, B. Cassie, and B. de La Fourni\`ere,
