...
- Source-family count/volume and ordering-fraction limits (#782): kernel-clean.
  ...
  assignment, including endpoint layers. `Geometry/GoldenSourceVolumeLimit.lean`
...
- `Geometry/SourceCountLimitAxiomAudit.lean`: admission checks and transitive axiom receipts for all 141 new public theorems plus the consumed golden quadrature and injectivity interfaces. Only propext, Classical.choice and Quot.sound occur.
