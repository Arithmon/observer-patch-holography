...
tetrahedron is the unique minimal optimizer, up to orientation and relabeling.
This determines a minimum number of coherent flight channels, not an OPH
observer population or a choice of central source ports.
...
unit sphere. Each has area at most $2\pi(1-|v|/c)$. If $N$ counts nonzero
...
$\max(0,s_{\min}(M)-\|u\|)$ in place of $|v|$, since that centered ball
lies in the velocity ellipsoid. Hence $M\to cR$, $u\to0$ requires
$N\to\infty$ without exact isotropy at any cutoff. The tetrahedral
