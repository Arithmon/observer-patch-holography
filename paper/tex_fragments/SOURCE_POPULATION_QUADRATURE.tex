...
are kernel-checked in \texttt{GoldenSourceCountLimit}. Identifying the
null frontier of a particular causal region, transferring the estimate to
moving generated-order intervals and deriving strict-pair limits remain
separate analytic arguments. Extra routing events require another count
