...
error. Evaluation of the geometric pair integral and the explicit
Alexandrov error remain analytic at this stage. Extra routing events require another count
estimate; the sampling theorem selects no physical measure or clock.
