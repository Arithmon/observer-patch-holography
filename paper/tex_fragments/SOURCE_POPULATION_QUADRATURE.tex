...
The golden floor/permutation argument, spacetime null-boundary estimates
and causal ordering-fraction integral are analytic arguments separate from
the formal cell-transport theorem.
