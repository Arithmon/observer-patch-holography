...
The unicast census accompanying these episodes applies their cost to the
declared-family read counts at $q=13,21$; it is not a full execution at
those sizes or a lower bound for other compiler designs.
Section~\ref{sec:source-read-routing} gives separate complete multicast
executions of the layered record recurrence on the wired support, with
all intermediate operations retained. That recurrence is distinct from
the scalar field Hamiltonian and its quantum instrument. Its local
feedback, metric read menu, placement and controller are supplied.
