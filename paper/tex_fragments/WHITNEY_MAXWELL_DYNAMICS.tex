...
energies and Heisenberg identities. The modules
\path{Lean/Screen/WhitneyNormalModeConstruction.lean},
\path{Lean/Screen/WhitneyConeModes.lean}, and
\path{Lean/Screen/WhitneyConeMass.lean} construct the complete positive
30-mode frame from the cone cochain maps and supplied symmetric
positive-definite Whitney mass forms. The frame-naturality modules prove that
the classical action and the full polynomial Hamiltonian, including the
zero-point term, are unchanged under mass-overlap transport between any two
admissible frames; the transition and its polynomial lift obey identity and
composition. The Hilbert completion and self-adjoint-domain argument are the
analytic proof just given, not Lean results. This is canonical quantization
of the free radiative sector.
