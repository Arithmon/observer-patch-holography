...
On a supplied fixed spatial cone, the charged scalar action supports controlled real-sector continuum trajectories, a neutral interacting Hilbert space with explicit initial states, and a Jacobi clock on regular nonturning solutions. These constructions use declared geometry, action parameters and energy; cosmological source selection, expanding geometry and physical calibration require the conditions below.
