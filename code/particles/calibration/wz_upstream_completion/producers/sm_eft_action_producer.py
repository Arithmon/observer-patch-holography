...
def convention_packet() -> dict[str, Any]:
    return {
        ...
        "fermion_action_chart": "four-component chiral bilinears; the census uses only left Weyl fields",
        "right_handed_dictionary": {
            "u_R": {"census_field": "u_c", "operation": "charge_conjugation"},
            "d_R": {"census_field": "d_c", "operation": "charge_conjugation"},
            "e_R": {"census_field": "e_c", "operation": "charge_conjugation"},
        },
...
def action_ast() -> dict[str, Any]:
    retained = [
        ...
        {"operator": "yukawa_up", "expression": "- Qbar Yu Htilde u_R + h.c.", "coupling": {"matrix": "Yu", "entries": yukawa_matrix("Yu")}},
        {"operator": "yukawa_down", "expression": "- Qbar Yd H d_R + h.c.", "coupling": {"matrix": "Yd", "entries": yukawa_matrix("Yd")}},
        {"operator": "yukawa_lepton", "expression": "- Lbar Ye H e_R + h.c.", "coupling": {"matrix": "Ye", "entries": yukawa_matrix("Ye")}},
