...
The compact capture is produced by the pinned
[simulator extractor](https://github.com/MarioPoneder/oph-physics-sim/blob/84d46b97b07965406c608e1465bec18b2a308372/oph_fpe/bulk/primitive_source_reads.py).
...
To reproduce the retained source revision:
...
Windows. The finite classical theorem in `source_read_selection` supplies
the support criterion used here.
...
measured extension. These controls do not select a canonical model.
