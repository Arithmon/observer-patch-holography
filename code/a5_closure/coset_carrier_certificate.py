...
CLAIM_BOUNDARY = (
    ...
    "of A5 by Z/2. The binary icosahedral group 2I is such an extension as well: its image in SO(3) is the "
    "icosahedral rotation group, isomorphic to A5, and -1 is its only involution. The identification of S "
    "with 2I rests on one cited fact: the Schur multiplier of A5 is Z/2 (I. Schur, printed as J. Schur, "
    "J. Reine Angew. Math. 139 (1911) 155-250, doi:10.1515/crll.1911.139.155); since A5 is "
