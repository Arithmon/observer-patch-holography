...
def payload() -> dict[str, Any]:
    ...
    deficits = {
        "independent_tangent_directions_missing": target_rank - current_rank,
    ...
    return {
        "schema": "arithmon.source_current_tomography_stage1_contract.v1",
...
def main() -> int:
    ...
    if args.command == "verify":
        gap = result["exact_gap"]
        require(gap["independent_tangent_directions_missing"] == 8, "rank gap drift")
