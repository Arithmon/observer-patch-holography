...
A region's entry is four numbers of that kind. The first is the rate the region is worked through against that region's own clock, which is its energy. The other three are the drift of its records across the seam network in the three directions of chapter fifteen, which is the quantity Newton listed second among his definitions and called the quantity of motion: momentum.
